...
REG='(^|[ /])dsh web( |$)|@deepseek-ai/dsh(@[^ /]+)?(/| web( |$))'
...
should_match "npx-versioned" "npx -y @deepseek-ai/dsh@0.1.5 web --no-open"
should_match "dsh-binary" "/opt/homebrew/bin/dsh web --no-open"
should_match "dsh-bare" "dsh web --no-open"
should_match "node-package" "node /tmp/node_modules/@deepseek-ai/dsh/dist/cli.js web --no-open"
...
should_reject "other-dsh-command" "dsh inspect --port 3080"
should_reject "package-lookalike" "node /tmp/@deepseek-ai/dsh-debug.js"
